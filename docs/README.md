...
Built for the Bessemer Tech Catalyst problem statement from Aivar Innovations: [*Autonomous Test Orchestration Agent*](problem-statement/problem-statment.md).
...
Work that is designed and descoped. Being able to show what you chose *not* to build is a form of rigour, not an admission.
